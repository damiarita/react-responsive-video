...
```html
<picture>
    <source width="666" height="666" srcset="https://example.com/big.avif" type="image/avif" media="(min-width: 1200px)">
    <source width="666" height="666" srcset="https://example.com/big.webp" type="image/webp" media="(min-width: 1200px)">
    <source width="666" height="666" srcset="https://example.com/big.jpg" media="(min-width: 1200px)">
    <source width="200" height="300" srcset="https://example.com/small.avif" type="image/avif">
    <source width="200" height="300" srcset="https://example.com/small.webp" type="image/webp">
